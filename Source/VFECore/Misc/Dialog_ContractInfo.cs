    ...
    public class Dialog_ContractInfo : Window
    {
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            if (contract.factionDef != null)
            {
                ...
                Widgets.DrawTextureFitted(iconRect, contract.factionDef.Texture, 1f, new Vector2(contract.factionDef.Texture.width, contract.factionDef.Texture.height),
                    new Rect(0f, 0f, 1f, 1f), 0, contract.factionDef.Material);
            }
            ...
            foreach (var pawn in contract.pawns)
            {
                ...
                if (pawn != contract.pawns[0]) Widgets.DrawLineHorizontal(pawnRect.x, pawnRect.yMax, pawnRect.width);
