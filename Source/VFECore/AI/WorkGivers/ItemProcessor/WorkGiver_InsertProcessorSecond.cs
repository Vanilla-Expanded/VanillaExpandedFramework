...
{
    public class WorkGiver_InsertProcessorSecond : WorkGiver_Scanner
    {
        ...
        public static void ResetStaticData()
        {
            ...
            WorkGiver_InsertProcessorSecond.NoIngredientFound = "IP_NoIngredientFound".Translate();
        }
        ...
        public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            if (building_processor == null || building_processor.processorStage != ProcessorStage.ExpectingIngredients || building_processor.secondIngredientComplete || building_processor.secondItem == "")
            {
                return false;
            }
        ...
        public override Job JobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            Thing t2 = this.FindIngredient(pawn, building_processor.secondItem, building_processor);
            return new Job(DefDatabase<JobDef>.GetNamed("IP_InsertSecondIngredient", true), t, t2);
        }

        private Thing FindIngredient(Pawn pawn, string secondItem, Building_ItemProcessor building_processor)
        {
            Predicate<Thing> predicate = (Thing x) => !x.IsForbidden(pawn) && pawn.CanReserve(x, 1, 1, null, false);
            IntVec3 position = pawn.Position;
            Map map = pawn.Map;
            ThingRequest thingReq = ThingRequest.ForDef(ThingDef.Named(secondItem));
