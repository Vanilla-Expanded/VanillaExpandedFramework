...
{
    public class WorkGiver_InsertProcessorFirst : WorkGiver_Scanner
    {
        ...
        public static void ResetStaticData()
        {
            ...
            WorkGiver_InsertProcessorFirst.NoIngredientFound = "IP_NoIngredientFound".Translate();
        }
        ...
        public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            if (building_processor == null || building_processor.processorStage != ProcessorStage.ExpectingIngredients || building_processor.firstIngredientComplete || building_processor.firstItem == "")
            {
                return false;
            }
        ...
        public override Job JobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            Thing t2 = this.FindIngredient(pawn, building_processor.firstItem, building_processor);
            return new Job(DefDatabase<JobDef>.GetNamed("IP_InsertFirstIngredient", true), t, t2);
        }

        private Thing FindIngredient(Pawn pawn, string firstItem, Building_ItemProcessor building_processor)
        {
            ...
            else
            {
                ...
                IntVec3 position = pawn.Position;
                Map map = pawn.Map;
                ThingRequest thingReq = ThingRequest.ForDef(ThingDef.Named(firstItem));
                PathEndMode peMode = PathEndMode.ClosestTouch;
                TraverseParms traverseParams = TraverseParms.For(pawn, Danger.Deadly, TraverseMode.ByPawn, false);
                Predicate<Thing> validator = predicate;
