...
public class CompStatsWhenPowered : ThingComp
{
    ...
    public override void GetStatsExplanation(StatDef stat, StringBuilder sb)
    {
        ...
        {
            true => ("VFECore.StatsReport_Powered", Props.poweredStatOffsets, Props.poweredStatFactors),
            false => ("VFECore.StatsReport_Unpowered", Props.unpoweredStatOffsets, Props.unpoweredStatFactors),
        };
