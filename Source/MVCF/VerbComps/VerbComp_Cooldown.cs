...
namespace MVCF.VerbComps
{
    public class VerbComp_Cooldown : VerbComp
    {
        ...
        public override IEnumerable<CommandPart> GetCommandParts(Command_VerbTargetExtended command) => base.GetCommandParts(command).Append(new CommandPart_Cooldown
        {
            parent = command,
            Comp = this
        });
