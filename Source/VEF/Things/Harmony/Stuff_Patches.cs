...
namespace VEF.Things
{
    ...
    public static class VanillaExpandedFramework_GenStuff_RandomStuffInexpensiveFor_Patch
    {
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator ilg)
        {
            ...
            var methodToCall = AccessTools.Method(typeof(VanillaExpandedFramework_GenStuff_RandomStuffInexpensiveFor_Patch), "TryRandomElementByWeightAndCommonality");
        ...
        {
            return enumerable.TryRandomElementByWeight((ThingDef x) => VanillaExpandedFramework_ThingStuffPair_Commonality_Patch.ModifyCommonalityOf(thingDefFor, x, x.stuffProps.commonality), out result);
        }
    }
