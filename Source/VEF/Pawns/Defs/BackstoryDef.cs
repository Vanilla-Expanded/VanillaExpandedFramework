namespace VEF.Pawns
{
	...
	public static class VanillaExpandedFramework_PawnGenerator_GenerateSkills
	{
	...
	public class VEBackstoryDef : BackstoryDef
	{
        ...
        public override void ResolveReferences()
        {
			...
			if (!passions.NullOrEmpty())
                VanillaExpandedFramework_PawnGenerator_GenerateSkills.PASSIONS.Add(this, this.passions);
        }
	}
}