            ...
            for (var i = 0; i < codes.Count; i++)
            {
                ...
                if (code.Calls(drawTextureInfo))
                {
                    ...
                    yield return new CodeInstruction(OpCodes.Call,
                        AccessTools.Method(typeof(VanillaExpandedFramework_SocialCardUtility_DrawPregnancyApproach_Patch), "InterceptTexture"));
                }
                if (code.Calls(tooltipHandlerTipRegionInfo))
                {
                    ...
                    yield return new CodeInstruction(OpCodes.Call,
                        AccessTools.Method(typeof(VanillaExpandedFramework_SocialCardUtility_DrawPregnancyApproach_Patch), "InterceptTooltip"));
                }
                if (code.Calls(messageInfo))
                {
                    ...
                    yield return new CodeInstruction(OpCodes.Ldfld, otherPawnField);
                    yield return new CodeInstruction(OpCodes.Call,
                        AccessTools.Method(typeof(VanillaExpandedFramework_SocialCardUtility_DrawPregnancyApproach_Patch), "InterceptMessage"));
                }
                else
                {
                ...
                if (code.Calls(get_WindowStackInfo) && codes[i + 1].opcode == OpCodes.Ldloc_3)
                {
                    ...
                    yield return new CodeInstruction(OpCodes.Call,
                        AccessTools.Method(typeof(VanillaExpandedFramework_SocialCardUtility_DrawPregnancyApproach_Patch), "AddPregnancyApproachOptions"));
                }
            }
        }
