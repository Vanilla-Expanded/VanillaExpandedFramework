...
namespace VEF.Pawns
{
    public static class PawnShieldGenerator
    {
        ...
        public static void Reset()
        {
            ...
            {
                return td.GetCompProperties<Apparels.CompProperties_Shield>() is Apparels.CompProperties_Shield shieldProps && !shieldProps.shieldTags.NullOrEmpty();
            }
        ...
        public static void TryGenerateShieldFor(Pawn pawn)
        {
            ...
            for (int i = 0; i < allShieldPairs.Count; i++)
            {
                ...
                {
                    var shieldProps = w.thing.GetCompProperties<Apparels.CompProperties_Shield>();
