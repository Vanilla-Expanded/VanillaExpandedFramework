...
public class ForcedMusicManager : GameComponent
{
    ...
    public static void ApplyPatches()
    {
        ...
        VEF_Mod.harmonyInstance.Patch(AccessTools.Method(typeof(MusicManagerPlay), "ChooseNextSong"), new HarmonyMethod(typeof(ForcedMusicManager), nameof(ChooseNextSong_Prefix)));
        VEF_Mod.harmonyInstance.Patch(AccessTools.PropertyGetter(typeof(MusicManagerPlay), "DangerMusicMode"), new HarmonyMethod(typeof(ForcedMusicManager), nameof(DangerMusicMode_Prefix)));
        patchesApplied = true;
    }
