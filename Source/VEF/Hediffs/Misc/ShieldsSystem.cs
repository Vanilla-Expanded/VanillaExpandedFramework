...
namespace VEF.Hediffs
{
    public static class ShieldsSystem
    {
        ...
        public static void ApplyDrawPatches()
        {
            ...
            VEF_Mod.harmonyInstance.Patch(AccessTools.Method(typeof(Pawn), nameof(Pawn.SpawnSetup)), postfix: nameof(OnPawnSpawn).MyMethod());
            VEF_Mod.harmonyInstance.Patch(AccessTools.Method(typeof(Pawn), nameof(Pawn.DeSpawn)),    postfix: nameof(OnPawnDespawn).MyMethod());
            VEF_Mod.harmonyInstance.Patch(AccessTools.Method(typeof(Pawn), "DrawAt"),     postfix: nameof(PawnPostDrawAt).MyMethod());
        }
        ...
        public static void ApplyShieldPatches()
        {
            ...
            VEF_Mod.harmonyInstance.Patch(AccessTools.Method(typeof(ThingWithComps), nameof(ThingWithComps.PreApplyDamage)),
                postfix: nameof(PostPreApplyDamage).MyMethod());
            VEF_Mod.harmonyInstance.Patch(AccessTools.Method(typeof(Verb), nameof(Verb.CanHitTarget)), postfix: nameof(CanHitTargetFrom_Postfix).MyMethod());
        }
