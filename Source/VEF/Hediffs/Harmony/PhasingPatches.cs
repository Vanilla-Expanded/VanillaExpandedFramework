...
namespace VEF.Hediffs
{
    public static class PhasingPatches
    {
        ...
        {
            harm.Patch(AccessTools.Method(typeof(PathFinder), "CreateRequest", new Type[]
            {
                typeof(IntVec3), typeof(LocalTargetInfo), typeof(IntVec3?), typeof(TraverseParms), typeof(PathFinderCostTuning?), typeof(PathEndMode), typeof(Pawn), typeof(PathRequest.IPathGridCustomizer)
            }), new HarmonyMethod(typeof(PhasingPatches), nameof(CreateRequest_Prefix)));
            ...
            harm.Patch(AccessTools.Method(typeof(Pawn_PathFollower), "BuildingBlockingNextPathCell"),
        ...
        {
            if (pawn is not null && pawn.IsPhasing())
            {
