...
namespace VEF.Genes
{
    ...
    public static class VanillaExpandedFramework_JobDriver_Vomit_MakeNewToils_Transpiler_Patch
    {
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> codeInstructions)
        {
            ...
            foreach (var code in codes)
            {
                ...
                if (code.opcode == OpCodes.Ldsfld && code.LoadsField(field))
                {
                    ...
                    yield return new CodeInstruction(OpCodes.Call,AccessTools.Method(typeof(VanillaExpandedFramework_JobDriver_Vomit_MakeNewToils_Transpiler_Patch), nameof(GetVomitFilth)));
        ...
        public static ThingDef GetVomitFilth() {
            ...
            if (VanillaExpandedFramework_JobDriver_Vomit_MakeNewToils_Patch.curPawn!=null&&
                StaticCollectionsClass.vomitType_gene_pawns.ContainsKey(VanillaExpandedFramework_JobDriver_Vomit_MakeNewToils_Patch.curPawn))
            {
                return StaticCollectionsClass.vomitType_gene_pawns[VanillaExpandedFramework_JobDriver_Vomit_MakeNewToils_Patch.curPawn];
            }
