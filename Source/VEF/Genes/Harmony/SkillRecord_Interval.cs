        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            foreach (var instruction in instructions)
            {
                ...
                if (instruction.opcode == OpCodes.Stloc_0)
                {
                    ...
                    yield return CodeInstruction.Call(typeof(VanillaExpandedFramework_SkillRecord_Interval_Transpiler_Patch), nameof(VanillaExpandedFramework_SkillRecord_Interval_Transpiler_Patch.GetMultiplier));
