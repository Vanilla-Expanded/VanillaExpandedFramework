    ...
    public class CachedPawnData : ICacheable
    {
        ...
        public bool RegenerateCache()
        {
            ...
            try
            {
                ...
                float sizeOffset = pawn.GetStatValue(VEFDefOf.VEF_BodySize_Offset);

                float cosmeticSizeOffset = pawn.GetStatValue(VEFDefOf.VEF_CosmeticBodySize_Offset);
                ...
                float sizeMultiplier = pawn.GetStatValue(VEFDefOf.VEF_BodySize_Multiplier);
                float cosmeticMultiplier = pawn.GetStatValue(VEFDefOf.VEF_CosmeticBodySize_Multiplier);
                ...
                float headScaleStat = pawn.GetStatValue(VEFDefOf.VEF_HeadSize_Cosmetic);

                var renderOffsetVal = pawn.GetStatValue(VEFDefOf.VEF_PawnRenderPosOffset);
                ...
                // Other cached data
                foodCapacityMult = pawn.GetStatValue(VEFDefOf.VEF_FoodCapacityMultiplier);
                growthPointMultiplier = pawn.GetStatValue(VEFDefOf.VEF_GrowthPointMultiplier);
