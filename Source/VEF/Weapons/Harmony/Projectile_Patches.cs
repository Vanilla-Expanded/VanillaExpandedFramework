    ...
    public static class VanillaExpandedFramework_Projectile_Launch_Patch
    {
            ...
            LocalTargetInfo intendedTarget, bool preventFriendlyFire, Thing equipment, ThingDef targetCoverDef)
        {
            if (__instance is ExpandableProjectile expandableProjectile)
            {
                ...
                {
                    var turretLocation = (Vector3)VanillaExpandedFramework_VehicleFramework_Turret_Patch.turretLocation
                        .Invoke(VanillaExpandedFramework_VehicleFramework_Turret_Patch.currentFiringVehicleTurret, null);
                    var turretRotation = (float)VanillaExpandedFramework_VehicleFramework_Turret_Patch.turretRotation
                        .Invoke(VanillaExpandedFramework_VehicleFramework_Turret_Patch.currentFiringVehicleTurret, null);
                    var aimPieOffset = (Vector2)VanillaExpandedFramework_VehicleFramework_Turret_Patch.aimPieOffset
                        .GetValue(VanillaExpandedFramework_VehicleFramework_Turret_Patch.currentFiringVehicleTurret);
