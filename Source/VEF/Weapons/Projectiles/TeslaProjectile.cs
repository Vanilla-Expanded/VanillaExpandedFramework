...
namespace VEF.Weapons
{
    ...
    public class TeslaProjectile : Bullet
    {
        ...
        protected virtual int GetDamageAmount => this.def.projectile.GetDamageAmount(1f,null);
        ...
        protected override void Impact(Thing hitThing, bool blockedByShield = false)
        {
            ...
            else if (hitThing != null && !shotAnything)
            {
                ...
                {
                    GenExplosion.DoExplosion(hitThing.Position, Map, Props.impactRadius, Props.explosionDamageDef, this.Launcher, this.def.projectile.GetDamageAmount(1f,null));
                }
