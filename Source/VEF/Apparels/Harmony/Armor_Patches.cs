    ...
    public static class Patch_ArmorUtility
    {
        ...
        public static class VanillaExpandedFramework_ArmorUtility_ApplyArmor
        {
            ...
            public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator ilGen)
            {
                ...
                yield return new CodeInstruction(OpCodes.Call, AccessTools.Method(typeof(VanillaExpandedFramework_ArmorUtility_ApplyArmor), nameof(IsShield))); // IsShield(armorThing)
                ...
                yield return new CodeInstruction(OpCodes.Call, AccessTools.Method(typeof(VanillaExpandedFramework_ArmorUtility_ApplyArmor), nameof(ShieldUseDeflectMetalEffect))); // ShieldUseDeflectMetalEffect(armorThing)
