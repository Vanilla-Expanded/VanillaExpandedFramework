    ...
    public static class Patch_ITab_Pawn_Gear
    {
        ...
        public static class VanillaExpandedFramework_ITab_Pawn_Gear_TryDrawOverallArmor
        {
            public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
            {
                ...
                var fromApparel = AccessTools.Method(typeof(VanillaExpandedFramework_ITab_Pawn_Gear_TryDrawOverallArmor), nameof(ShieldFromApparel));
                var fromEquipment = AccessTools.Method(typeof(VanillaExpandedFramework_ITab_Pawn_Gear_TryDrawOverallArmor), nameof(ShieldFromEquipment));
