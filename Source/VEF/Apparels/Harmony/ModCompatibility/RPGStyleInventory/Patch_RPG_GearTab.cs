...
namespace VEF.Apparels
{
    public static class Patch_RPG_GearTab
    {
        ...
        public static IEnumerable<CodeInstruction> TryDrawOverallArmor_Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            var fromApparel = AccessTools.Method(typeof(Patch_ITab_Pawn_Gear.VanillaExpandedFramework_ITab_Pawn_Gear_TryDrawOverallArmor), "ShieldFromApparel");
            var fromEquipment = AccessTools.Method(typeof(Patch_ITab_Pawn_Gear.VanillaExpandedFramework_ITab_Pawn_Gear_TryDrawOverallArmor), "ShieldFromEquipment");
