                        ...
                        if (pawn != null)
                        {
                            ...
                            if (parent.Map != null)
                            {
                                ...
                                if (AnimalBehaviours_Settings.flagExplodingAnimalEggs) {
                                    GenExplosion.DoExplosion(parent.Position, parent.Map, Props.range, DefDatabase<DamageDef>.GetNamed(Props.damageDef), parent, Props.damage, -1, SoundDef.Named(Props.soundDef), null, null, null, null, 0f, 1, null, null,255,false, null, 0f, 1, 0, false, null, ignoredThings);
                                }
