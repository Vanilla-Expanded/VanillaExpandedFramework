...
namespace VEF.AnimalBehaviours
{
    ...
    public static class VanillaExpandedFramework_Pawn_MindState_StartFleeingBecauseOfPawnAction_Patch
    {
...

        {
            ...
            bool flagDoesCReatureNotFlee = StaticCollectionsClass.nofleeing_animals.Contains(__instance.pawn);
    ...
    public static class VanillaExpandedFramework_PawnUtility_IsFighting_Patch
    {
        ...
        {
            if (pawn != null && StaticCollectionsClass.nofleeing_animals.Contains(pawn) && pawn.CurJob != null) { __result = true; }
